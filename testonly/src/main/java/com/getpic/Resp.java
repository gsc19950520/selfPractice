...
public class Resp<T> {
    ...
    public static <T> Resp<T> error() {
        return new Resp<T>(ERROR, null, null);
    }

    public static <T> Resp<T> error(String msg) {
        return new Resp<T>(ERROR, msg, null);
    }

    public static <T> Resp<T> error(String msg, T body) {
        return new Resp<T>(ERROR, msg, body);
    }

    public static <T> Resp<T> success() {
        return new Resp<T>(SUCCESS, null, null);
    }

    public static <T> Resp<T> success(String msg) {
        return new Resp<T>(SUCCESS, msg, null);
    }

    public static <T> Resp<T> success(T body) {
        return new Resp<T>(SUCCESS, "", body);
    }

    public static <T> Resp<T> success(String msg, T body) {
        return new Resp<T>(SUCCESS, msg, body);
    }
